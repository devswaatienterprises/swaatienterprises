...
export default function ReportsPage() {
  ...
  const [activeTab, setActiveTab] = useState('payroll'); // 'payroll' | 'tasks' | 'leads' | 'leaves'
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6">
        ...
        <div className="flex flex-wrap items-center gap-2">
          <button
            ...
            className="px-3.5 py-2 bg-white hover:bg-slate-50 text-slate-700 border border-slate-200 rounded-lg text-xs font-bold shadow-2xs flex items-center gap-1.5 transition-colors"
          >
          ...
          <button
            ...
            className="px-4 py-2 bg-emerald-600 hover:bg-emerald-500 text-white rounded-lg text-xs font-bold shadow-sm shadow-emerald-600/20 flex items-center gap-1.5 transition-all"
          >
